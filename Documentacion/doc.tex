...
\begin{titlepage}
    ...
    {\large \bf Documentación Técnica Detallada:\\Sistema de Simulación y Optimización de Ruido en Edificios\par}
    \vspace{8cm} % Espaciado extra después del título
    
    {\Large Integrantes:\par}
    {\large Juan Manuel Serrano Rodríguez\par}
    {\large David Santiago Torres Mendieta\par}
    \vspace{6.5cm} % Espaciado extra después de la lista de integrantes
    
    {\large Universidad Distrital Francisco José de Caldas\par}
    {\large Facultad de Ingeniería\par}
    {\large Ciencias de la Computación II\par}    
    {\large Bogotá, 2025\par}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.48\textwidth]{grafoInicial.png}
    \hfill
    \includegraphics[width=0.48\textwidth]{grafoSolucion.png}
    \caption{Comparativa: Gráfica Inicial (izquierda) y Gráfica Optimizada (derecha)}
    \label{fig:graficos_inicial_solucion}
\end{figure}
...
\begin{itemize}
    \item Genera un listado del estado de cada espacio
    \item Muestra sugerencias rápidas de mitigación
\end{itemize}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{reporteInicial.png}
    \caption{Pantallazo del Reporte Inicial}
    \label{fig:reporte_inicial}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{reporteSolucion.png}
    \caption{Pantallazo del Reporte Final con la Solución}
    \label{fig:reporte_solucion}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{reporteSolucion2.png}
    \caption{Pantallazo del Reporte Final con la Solución}
    \label{fig:reporte_solucion}
\end{figure}
...
\begin{itemize}
    ...
    \begin{enumerate}
        ...
        \item Salir
    \end{enumerate}
    \item \textbf{Vista de la Interfaz Principal:}
\end{itemize}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{principal.png}
